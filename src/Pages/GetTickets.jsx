...
const events = [
  {
    ...
    description:
      "The words in this book are drawn from the Bible. They are specially chosen to build and inspire our children. By regularly reading and internalizing these words, our children are expected to grow up to become great role models and respectable leaders in our communities.",
  },
];
  ...
  const handleCheckout = async (e) => {
    ...
    try {
      const response = await axios.post(
        "https://doctor-comform-website.onrender.com/tickets/buy-ticket",
        {
          email,
          quantity,
    ...
    <div className="fixed inset-0 bg-black/50 flex items-center justify-center p-4 z-50">
      <div className="bg-white rounded-3xl p-8 max-w-md w-full">
        <div className="flex justify-between items-center mb-6">
          <h3 className="text-2xl font-bold text-[#2e2c2b]">
            {selectedTicket.type}
          </h3>
          <button
            onClick={onClose}
        ...
        {success ? (
          <div className="text-center py-8">
            ...
            <h4 className="text-xl font-bold text-[#d84136] mb-2">
              Checkout Started
            </h4>
          ...
          <>
            <p className="text-3xl font-bold text-[#d84136] mb-2">
              ${selectedTicket.price}
            </p>
            <p className="text-sm text-[#2e2c2b]/60 mb-6">
              per ticket × {quantity} ticket(s)
            </p>

            <form onSubmit={handleCheckout} className="space-y-4">
              <div>
                <label className="block text-sm font-semibold text-[#2e2c2b] mb-2">
                  Email Address
                </label>
                <input
                  type="email"
        ...
        <div className="max-w-6xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-12">
              <div>
                ...
                <p className="leading-relaxed opacity-80">
                  Experience the transformative power of communal prayer and
                  discover how faith can reshape your life and purpose.
                </p>
              </div>
              <div>
                <h3 className="text-2xl font-bold mb-4">
                ...
                <p className="leading-relaxed opacity-80">
                  Connect with like-minded women in a safe, uplifting space
                  designed to strengthen your spiritual journey and personal
                  growth.
                </p>
              </div>
              <div>
                ...
                <p className="leading-relaxed opacity-80">
                  Learn how to live out your faith intentionally with practical
                  wisdom that translates your beliefs into daily action.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="mt-16 text-center text-[#2e2c2b]/70">
            <p className="text-sm mb-4">
              Have questions?{" "}
              <a
                href="mailto:info@brunchandpray.com"
                className="text-[#d84136] font-bold hover:underline"
              >
                Contact us
              </a>
            </p>
