...
const Hero = () => {
  return (
    <section className="relative min-h-screen pt-32 pb-20 px-6 bg-[url('/background.jpg')] flex flex-col items-center overflow-hidden bg-white">
      ...
      <div className="text-center max-w-4xl z-10">
        <h1 className="uppercase font-black lg:text-9xl text-6xl tracking-wide text-[#2e2c2b] lg:leading-32 mb-6 lg:mt-0 mt-6">
        ...
        <div className="mt-10 flex gap-4 justify-center lg:flex-row flex-col">
          ...
          <button className="border border-gray-100 text-[#2e2c2b] px-10 py-4 rounded-full font-bold tracking-widest hover:bg-white/50 transition-all bg-white">
            OUR MISSION
          </button>
        </div>
      </div>
