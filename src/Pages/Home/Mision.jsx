...
<div className="flex-1 flex flex-col justify-center text-center lg:text-left">
  ...
  <p className="text-[#333] leading-[1.7] text-[0.92rem] sm:text-[0.95rem] md:text-[1rem] line-clamp-5 overflow-hidden max-w-[580px] mx-auto lg:mx-0">
    ...
    <Link to="/mission">
      <button className="bg-[#D97706] text-white px-5 py-2 rounded-full uppercase text-[10px] tracking-[0.2em] hover:bg-[#B45309] transition">
        ...
        <div className="flex-1 flex items-center justify-center w-full">
          ...
          <div className="grid grid-cols-2 gap-2 sm:gap-3 scale-[0.75] sm:scale-[0.85] md:scale-90 lg:scale-80 origin-center">

            <img
              src={missionImg1}
              alt="mission"
              className="w-[120px] h-[120px] sm:w-[140px] sm:h-[140px] md:w-[160px] md:h-[160px] object-cover animate-float1"
            ...
            <img
              src={missionImg2}
              alt="mission"
              className="w-[120px] h-[120px] sm:w-[140px] sm:h-[140px] md:w-[160px] md:h-[160px] object-cover animate-float2"
            ...
            <img
              src={missionImg3}
              alt="mission"
              className="w-[120px] h-[120px] sm:w-[140px] sm:h-[140px] md:w-[160px] md:h-[160px] object-cover animate-float3"
            ...
            <img
              src={missionImg4}
              alt="mission"
              className="w-[120px] h-[120px] sm:w-[140px] sm:h-[140px] md:w-[160px] md:h-[160px] object-cover animate-float4"
