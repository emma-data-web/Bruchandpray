...
const PastEvents = () => {
  return (
    <section className="w-full bg-white py-16 md:py-20 px-6 md:px-16 flex items-center">

      <div className="max-w-[1300px] mx-auto flex flex-col lg:flex-row gap-12 items-center w-full">
        ...
        <div className="w-full lg:w-1/2 flex flex-col justify-center">
          ...
          <h2 className="text-3xl md:text-4xl font-semibold text-[#1A1A1A]">
            Past{" "}
            <span className="text-[#F39221] italic">Moments</span>
          </h2>
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            {pastEvents.slice(0, 2).map((event, i) => (
              <div key={i} className="bg-[#F7F7F7] rounded-xl overflow-hidden shadow-sm">
        ...
        <div className="w-full lg:w-1/2 flex justify-center">
          ...
          <div className="relative w-full sm:w-[85%] h-[55vh] md:h-[70vh] rounded-3xl overflow-hidden shadow-2xl bg-white flex flex-col">
            ...
            <div className="flex-1 relative">
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                ...
                <div className="w-16 h-16 bg-white/80 rounded-full flex items-center justify-center shadow-lg">
                  ...
                  <div className="w-0 h-0 border-l-[10px] border-l-[#F39221] border-y-[7px] border-y-transparent ml-1" />
            ...
            <div className="p-5 bg-white">
              ...
              <p className="text-[#1A1A1A] text-sm md:text-[15px] leading-relaxed">
                “A glimpse into the heart of our sisterhood.
                Worship, healing, laughter, and encounters with God”
              </p>
