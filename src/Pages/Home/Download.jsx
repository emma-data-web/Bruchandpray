...
const Download = () => {
  return (
    <div className="px-6 py-20 bg-[#F39221]">
      <div className="max-w-6xl mx-auto bg-black from-[#1A0F1F] via-[#2A1233] to-[#3A1745]
      lg:rounded-[60px] rounded-2xl p-10 md:p-24 flex flex-col md:flex-row items-center gap-16 relative
      overflow-hidden">
